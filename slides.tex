...
\begin{block}{}
  \small{Given a set of robots, algorithm takes various of
    representations of formation patterns and generates robot motion
    to form various formation patterns using only local information.}
  \begin{columns}[T] % align columns
